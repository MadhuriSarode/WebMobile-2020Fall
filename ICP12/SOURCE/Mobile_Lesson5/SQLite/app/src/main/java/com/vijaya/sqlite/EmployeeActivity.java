...
public class EmployeeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.clearResults.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                clearResults();
            }
    ...
    private void readAllFromDB() {
        ...
        SQLiteDatabase database = new SampleDBSQLiteHelper(this).getReadableDatabase();
        String[] selectionArgs = {"%" + firstname + "%", "%" + lastname + "%"};
        Cursor cursor = database.rawQuery(SampleDBContract.SELECT_ALL_EMPLOYEES, selectionArgs);
        binding.recycleView.setAdapter(new SampleJoinRecyclerViewCursorAdapter(this, cursor));
    }
    ...
    private void updateDB(){
        ...
        Toast.makeText(EmployeeActivity.this, "The record has been updated for " + firstname, Toast.LENGTH_LONG).show();
        readFromDB();
    }
    ...
    private void deleteFromDB(){
        ...
        Toast.makeText(EmployeeActivity.this, "The record for deletion is  " + firstname, Toast.LENGTH_LONG).show();
...
//        database.delete(SampleDBContract.Employee.TABLE_NAME,   "COLUMN_FIRSTNAME =?" , selectionArgs);
        Toast.makeText(EmployeeActivity.this, "The record has been deleted for " + firstname + " and the ID number id " + id, Toast.LENGTH_LONG).show();
