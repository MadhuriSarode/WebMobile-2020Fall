...
public final class SampleDBContract {
    ...
    public static final String SELECT_EMPLOYER_WITH_EMPLOYER = "SELECT * " +
            "FROM " + Employer.TABLE_NAME + " ee  WHERE " +
            "ee." + Employer.COLUMN_NAME + " like ? AND ee." + Employer.COLUMN_DESCRIPTION + " like ?";
