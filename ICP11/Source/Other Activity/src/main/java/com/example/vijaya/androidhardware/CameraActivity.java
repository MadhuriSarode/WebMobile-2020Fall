...
public class CameraActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Required permissions for the emulator to access camera is granted.
    ...
    /**
     * Camera activity started with camera action from media store. Activity started for camera's picture.
     * @param v
     */
